...
> {
  public constructor(
    props: ISsimsDashboardProps,
    state: ISsimsDashboardState
  ){
    super(props);
    this.state = {
      searchData: "",
...
public async getData() {
  ...
  let tableListData = [...VisitorRequestForm.value, ...contractorForm.value,];
  const filteredItems = tableListData.filter((item: any) => item.PendingWith === "manager");
