...
import styles from "./ContractorManagerViewTable.module.scss";
...
interface IContractorManagerViewTableState {
  searchData: string;
  tableData: DataType[];
  activeNav: string;
  intialTableData: any;
...
export default class ContractorManagerViewTable extends React.Component<
  IContractorManagerViewTableProps,
  IContractorManagerViewTableState
> {
  public constructor(
    props: IContractorManagerViewTableProps,
    state: IContractorManagerViewTableState
  ) {
    super(props);
    this.state = {
      searchData: "",
  ...
  public render(): React.ReactElement<IContractorManagerViewTableProps> {
          ...
          <div className="pb-5">
            ...
            <div className="d-flex justify-content-between align-items-center p-3 px-4">
              <div className="visitorHeading">
                Contractor/ Trainee Requests (Manager view)
              </div>
            </div>

            <div className="px-4">
              <Table
                columns={activeNav === "Home" ? this.columns : this.columnsTask}
