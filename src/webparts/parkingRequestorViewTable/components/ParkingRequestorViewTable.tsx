...
interface IParkingRequestorViewTableState {
  searchData: string;
  tableData: DataType[];
  activeNav: string;
  intialTableData: any;
...
export default class VisitorAccessEndUserTable extends React.Component<
  IParkingRequestorViewTableProps,
  IParkingRequestorViewTableState
> {
  public constructor(
    props: IParkingRequestorViewTableProps,
    state: IParkingRequestorViewTableState
  ) {
    super(props);
    this.state = {
      searchData: "",
  ...
  public render(): React.ReactElement<IParkingRequestorViewTableProps> {
          ...
          <div className="pb-5">
            ...
            <div className="d-flex justify-content-between align-items-center p-3 px-4">
              <div className="visitorHeading">
                Parking Requests (Requestor View)
              </div>
            </div>
