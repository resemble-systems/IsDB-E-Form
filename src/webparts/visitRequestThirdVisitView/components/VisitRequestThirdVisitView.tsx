...
import type { IVisitRequestThirdVisitViewProps } from "./IVisitRequestThirdVisitViewProps";
...
interface IVisitRequestThirdVisitViewState {
  inputFeild: any;
  visitorIdProof: any;
  visitorPhoto: any;
  language: any;
...
export default class VisitRequestThirdVisitView extends React.Component<
  IVisitRequestThirdVisitViewProps,
  IVisitRequestThirdVisitViewState
> {
  public constructor(
    props: IVisitRequestThirdVisitViewProps,
    state: IVisitRequestThirdVisitViewState
  ) {
    super(props);
    this.state = {
      inputFeild: {
  ...
  public render(): React.ReactElement<IVisitRequestThirdVisitViewProps> {
    let bootstarp5CSS =
