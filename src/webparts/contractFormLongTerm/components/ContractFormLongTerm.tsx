...
import styles from "./ContractFormLongTerm.module.sass";
import type { IContractFormLongTermProps } from "./IContractFormLongTermProps";
...
interface ContractFormLongTermState {
  inputFeild: any;
...
export default class ContractFormLongTerm extends React.Component<
  IContractFormLongTermProps,
  ContractFormLongTermState
> {
  public constructor(
    props: IContractFormLongTermProps,
    state: ContractFormLongTermState
  ) {
    super(props);
    this.state = {
      inputFeild: {
  ...
  public componentDidUpdate(
    prevProps: Readonly<IContractFormLongTermProps>,
    prevState: Readonly<ContractFormLongTermState>
  ): void {
  ...
  public render(): React.ReactElement<IContractFormLongTermProps> {
    ...
    return (
      <CommunityLayout
        ...
        context={context}
        searchShow={false}
        selectedTitle=" Long Term Contractor Form"
      >
        <div className="container py-4 mb-5 bg-white shadow-lg">
          ...
          >
            Trainee/Contract Form (Long term contract)
          </div>
          <div
